...
@endphp
<button title="{{ $title }}" {{ $attributes->merge(['class' => 'flex justify-center items-center p-1 hover:transition-colors hover:duration-500 ' . $color]) }} wire:loading.attr="disabled" wire:offline.attr="disabled" wire:loading.class="cursor-wait">
