<nav class="px-4 bg-secondary-500 dark:bg-gray-800">
    <div class="2xl:container mx-auto">
        <div class="flex">
            ...
            <div id="mainMenu" class="z-10 w-full h-full lg:max-w-full sm:max-w-xs max-w-sm lg:static fixed top-0 left-0 lg:translate-x-0 -translate-x-full transition-transform duration-500 bg-secondary-500">
                ...
                <div class="h-full flex lg:flex-row flex-col overflow-y-auto lg:divide-none divide-y divide-secondary-100 dark:divide-gray-600 lg:pb-0 pb-12 bg-secondary-500 dark:bg-gray-800">
                    ...
                    <a wire:navigate href="" class="flex items-center px-3 py-2 hover:bg-secondary-700 dark:hover:bg-gray-700 transition-colors duration-500 {{ request()->routeIs('contact') ? 'bg-secondary-700 dark:bg-gray-700' : '' }}">Track Order</a>
