<div class="flex sm:max-w-sm w-full relative" x-data="{ categories: false }">
    <button x-on:click="categories = !categories" x-on:click.away="categories = false" @if (empty($categories)) wire:click="getCategories" @endif class="flex items-center justify-between gap-1 bg-primary-500 hover:bg-primary-700 dark:bg-secondary-500 dark:hover:bg-secondary-700 hover:transition-colors hover:duration-500 px-3 py-1.5 w-full" title="All Categories">
    ...
    <ul x-show="categories" x-transition x-transition:enter.duration.500ms x-collapse class="list-none w-full absolute z-40 left-0 top-full font-medium bg-white shadow-md divide-y divide-gray-400 dark:divide-gray-700 dark:bg-gray-900 text-gray-900 dark:text-gray-200 border border-gray-400 dark:border-gray-700" style="display: none;">
        ...
        @empty
            <li class="block h-9 bg-gray-300 dark:bg-gray-600 animate-pulse"></li>
            <li class="block h-9 bg-gray-300 dark:bg-gray-600 animate-pulse"></li>
            <li class="block h-9 bg-gray-300 dark:bg-gray-600 animate-pulse"></li>
            <li class="block h-9 bg-gray-300 dark:bg-gray-600 animate-pulse"></li>
            <li class="block h-9 bg-gray-300 dark:bg-gray-600 animate-pulse"></li>
