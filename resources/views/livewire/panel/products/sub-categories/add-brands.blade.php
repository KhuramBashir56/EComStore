...
<section class="grid gap-4">
    <x-panel.navigation>
        <x-ui.links.link :link="__('default')" wire:navigate href="{{ route('admin.products.sub_categories.details', ['category' => $category->id]) }}" :title="__('Go Back')" class="font-medium whitespace-nowrap rounded-md" />
