...
<section class="grid gap-4">
    <x-panel.navigation>
        <div class="w-full flex xs:gap-x-2 md:justify-start justify-center items-center">
            ...
            <x-ui.form.tab class="{{ $product->content ? 'text-gray-900 dark:text-gray-100' : 'text-gray-400 dark:text-gray-600' }}" :index="3" :title="__('Description')" :icon="__('keyboard_double_arrow_right')" />
